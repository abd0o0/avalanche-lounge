        ...
        <div className="flex justify-between items-center h-20">
          ...
          <Link to="/" className="group">
            <div className="flex items-center space-x-3">
              <div className="relative">
                ...
                <img
                  className="relative w-12 h-12 lg:w-14 lg:h-14 rounded-full shadow-xl border-2 border-white/20 transform transition-all duration-300 group-hover:scale-110 group-hover:rotate-12"
            ...
            <ul className="flex space-x-1">
              {menuItems.map((item) => (
                <li key={item.name}>
                  <Link
                    to={item.path}
                    className={`relative px-4 py-2 text-sm font-semibold tracking-wide transition-all duration-300 rounded-lg overflow-hidden block group ${
          ...
          <div className="lg:hidden flex items-center space-x-3">
            ...
            <button
              ...
              className="p-2 rounded-xl text-gray-300 hover:bg-white/10 transition-all duration-300"
            >
