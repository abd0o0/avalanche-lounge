...
function Event() {
  ...
  return (
    <>
      <div id="event" className="w-full h-fit bg-white dark:bg-gray-950 dark:text-white md:overflow-hidden ">
        <section className="w-full h-full py-12 md:py-24 lg:py-32 bg-gray-50 dark:bg-gray-950 flex justify-center md:overflow-hidden ">
          <div className="container relative items-center justify-center gap-4 px-4 text-center md:px-6">
            <div className="space-y-4">
              ...
              <div className="flex w-full h-80 rounded-full items-center px-40  bg-gray-100 dark:bg-gray-900 justify-between shadow-md">
                <img
                  src={game}
                  alt="game"
                  loading="lazy"
        ...
        <div className="min-h-screen bg-white dark:bg-gray-950 p-4">
          <div className="container mx-auto flex flex-col flex-col-reverse lg:flex-row space-y-4 lg:space-y-0 lg:space-x-4">
            {/* Calendar */}
            <div className="bg-gray-50 dark:bg-gray-900 shadow-md rounded-lg p-6 w-full lg:w-1/3">
              ...
              <div className="text-center mt-4">
                <button onClick={handleRegisterClick} className="bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-white px-4 py-2 rounded-md mt-4">
                  Register for Event
                </button>
              </div>
              <div className="text-center mt-4">
                <button className="bg-gray-100 dark:bg-gray-800 border border-green-500 px-4 py-2 rounded-md mt-2 text-green-500 dark:text-black hover:bg-green-500 hover:text-white">
                  Learn More
                </button>
              </div>
            </div>
            {/* Pictures */}
            <div className="bg-gray-50 dark:bg-gray-900 shadow-md rounded-lg p-6 w-full lg:w-2/3">
