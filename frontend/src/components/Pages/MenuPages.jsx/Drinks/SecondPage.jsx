  ...
  <div className="h-full w-full relative overflow-hidden">
    ...
    <div className="relative z-10 h-full flex flex-col p-3 md:p-5 overflow-hidden">
      ...
      <div className="flex-1 overflow-hidden">
        <div className="mb-3">
          <ST en="Speziel Cocktails (Alkoholfrei)" />
          <MI name="Avalanche Cocktail" price="9,00 EUR" />
          <MI name="Hawaii" price="8,00 EUR" />
          <MI name="Jamaika" price="8,00 EUR" />
          <MI name="Tropikal" price="8,00 EUR" />
          <MI name="Hugo" price="8,00 EUR" />
          <MI name="Chocodemo" price="8,00 EUR" />
          <MI name="Banane Milch & Erdbeere" price="8,00 EUR" />
        </div>
        <div>
          <ST en="Alkohol Getranke" />
          <MI name="Wodka Red Bull" price="8,00 EUR" />
          <MI name="Wodka Orange" price="8,00 EUR" />
          <MI name="Wodka Mojito" price="8,00 EUR" />
          <MI name="Whisky Cola" price="8,00 EUR" />
        </div>
      </div>
    </div>
  </div>
