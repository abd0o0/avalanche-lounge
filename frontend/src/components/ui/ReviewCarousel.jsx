...
const ReviewCarousel = () => {
  ...
  return (
    <div className="mb-20 bg-white dark:bg-gray-950 dark:text-white">
      ...
      <div className="slider bg-white dark:bg-gray-950 dark:text-white" style={{ position: 'relative', marginTop: '100px', width: '100%', height: '550px', overflow: 'hidden' }}>
